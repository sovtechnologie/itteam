      ...
      <section className="privacy">
        <div className="privacy-overlay">
          ...
          <p class="privacy-description">
            By accessing and using this platform, users acknowledge that they have read, understood, 
            and agreed to comply with all the rules, policies, and guidelines outlined in the Terms and Conditions.
          </p>
          <button className="privacy-button">Contact Us</button>
        </div>
      </section>

      <div className="privacyBox">
        <div className="privacy-content">
          <h1 className="privacy-heading1">
            Terms and<span className="highlight">conditions</span>
          </h1>

          <div className="privacy-text">
            <p>
              These terms and conditions outline the rules and regulations for the use of IT Team Website, located at Itteam.com.
            </p>
            <p>
            ...
            <p>
              Removal of links from our websiteIf you find any link on our Website that is offensive for any reason, you are free to contact and inform us any moment. We will consider requests to remove links but we are not obligated to or so or to respond to you directly.
            </p>
            <p>
